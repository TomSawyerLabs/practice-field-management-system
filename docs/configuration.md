...
| `MATCH_RECORDINGS_DIR`           | `recordings`                        | Where recorded matches and practice runs are stored (one directory per match id / run id; the practice ring buffer lives in `.practice-buffer/` underneath, and the long-term timelapse in `.timelapse/`).                                                                                                                                                                                           |
