...
| `/api/recordings*`              | Recorder status and match / practice-run video downloads (Range-capable MP4; `?download=1` for an attachment) — see [match video recording](match-system.md#match-video-recording)                                                                                                                   |
